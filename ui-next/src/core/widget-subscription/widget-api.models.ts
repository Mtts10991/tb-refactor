...
/** Stub HttpErrorResponse — parity กับ Angular */
interface HttpErrorResponse { status: number; statusText: string; error: unknown; url?: string; }
...
/* TODO Phase 2: MatDialogRef — will be replaced with HeroUI Modal */
type MatDialogRef<T = unknown> = { afterClosed: () => { subscribe: (cb: (r: T | undefined) => void) => { unsubscribe: () => void } }; close: (result?: T) => void };
